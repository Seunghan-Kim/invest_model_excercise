...
def get_df_with_features(
    ...
    rsi_pivot_short = calc_rsi_pivot(close_pivot, 14, SHORT_PERIOD)
    rsi_pivot_mid = calc_rsi_pivot(close_pivot, 14, MID_PERIOD)
    rsi_pivot_long = calc_rsi_pivot(close_pivot, 14, LONG_PERIOD)
    ...
    new_features_concatenated = pd.concat(
        [
            ...
            get_stacked_df(rsi_pivot_short, 'rsi_pivot_short'),
            get_stacked_df(rsi_pivot_mid, 'rsi_pivot_mid'),
            get_stacked_df(rsi_pivot_long, 'rsi_pivot_long'),

            get_stacked_df(
                get_future_rtn(6), 'rtn_6'
            ),

            get_stacked_df(
                get_future_rtn(7), 'rtn_7'
            ),
