...
class KisApiHandler:
    ...
    def __init__(self):
        ...
        if IS_RUN_ON_DATABUTTON:
            ...
            load_dotenv()
            self.key = os.getenv('shkim_app_key')
            self.secret = os.getenv('shkim_app_secret')
            self.acc_no = os.getenv('shkim_account_no')
    ...
    def get_df_bdate_n_days_before(self, n_days, date_ref):
        """
        Get business date n days prior to the date_ref
